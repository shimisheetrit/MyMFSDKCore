...
- (void)viewDidLoad {
    ...
    self.bannerAdRect = CGRectMake((screenWidth-bannerWidth)/2, 600 , bannerWidth, bannerHeight);
    
    //CGRect absolutePosition = [self.view convertRect:self.bannerAdRect toView:nil];
    //NSLog(@"absolutePosition: %@", absolutePosition);
...
>>>>>>> 7f3b59d692a90101b50fb638cca9025a951af8a2
