...
@protocol MobFoxAdNewDelegate <NSObject>

@optional

- (void)MobFoxAdDidLoad:(MobFoxAdNew *)banner;
...
@interface MobFoxAdNew : UIView <WKNavigationDelegate, MobFoxCustomEventDelegate, UIGestureRecognizerDelegate>


    @property (nonatomic, weak) id <MobFoxAdNewDelegate> delegate;
